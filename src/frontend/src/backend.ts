...
import type { OrderConfirmation as _OrderConfirmation, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderConfirmation]): OrderConfirmation | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        minecraftUsername: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.minecraftUsername))
    };
}
