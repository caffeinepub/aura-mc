...
import type { OrderConfirmation as _OrderConfirmation, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: OrderPayload): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllOrders(): Promise<Array<OrderConfirmation>> {
        if (this.processError) {
            try {
    ...
    async getBestSellingProducts(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getItemsByProduct(arg0: string): Promise<Array<OrderItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemsByProduct(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOrderById(arg0: bigint): Promise<OrderConfirmation | null> {
        if (this.processError) {
            try {
    ...
    async getOrdersByBuyer(arg0: string): Promise<Array<OrderConfirmation>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderConfirmation]): OrderConfirmation | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        minecraftUsername: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.minecraftUsername))
    };
}
...
function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        minecraftUsername: value.minecraftUsername ? candid_some(value.minecraftUsername) : candid_none()
    };
}
