    ...
    subcategories: [
      {
        ...
        name: 'Ranks',
        products: [
          { id: 'lifesteal-hero', name: 'Hero Rank 🎖️', price: 299, category: 'lifesteal', subcategory: 'ranks' },
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { id: 'tokensmp-boss', name: 'Boss 🌡️ Rank', price: 350, category: 'tokensmp', subcategory: 'ranks' },
    ...
    subcategories: [
      {
        ...
        products: [
          ...
          { id: 'aurasmp-aura', name: 'Aura ♥️ Rank', price: 450, category: 'aurasmp', subcategory: 'ranks' },
          { id: 'aurasmp-auraplus', name: 'Aura+ ❤️‍🔥 Rank', price: 625, category: 'aurasmp', subcategory: 'ranks' },
        ],
      },
      {
        id: 'coins',
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { id: 'boxpvp-4000coins', name: '4000 🪙 Coins Bank', price: 850, category: 'boxpvp', subcategory: 'coins' },
        ],
      },
    ],
  },
        ...
        products: [
          {
            ...
            bundleNote: 'Valid in any 1 realm'
          },
        ],
      },
    ],
